...
function applyUserPermissions(){
  ...
  const permissions = {
    formView: !!user.canForm || (user.viewAreas || []).length > 0,
    dashboardView: !!user.canDashboard || (user.viewAreas || []).length > 0,
    reportView: !!user.canReport || (user.viewAreas || []).includes('FINANCAS'),
